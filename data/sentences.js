...
window.GH_BANK = {
  ...
  categories: [
    ...
    { id:'lookfeel', glyph:'🎨', ru:'Цвета и описания', de:'Farben und Beschreibungen', en:'Colors & descriptions' },
    { id:'household', glyph:'🧼', ru:'Дом и полезные вещи', de:'Haushalt und praktische Dinge', en:'Household & practical things' },
    { id:'whenwhere', glyph:'📍', ru:'Время, места и дела', de:'Zeit, Orte und Erledigungen', en:'Time, places & errands' }
  ],
